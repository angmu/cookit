	...
	<div id="wrap">
		<div id="manage_main">
			...
			<div id="contentArea">
				...
				<form action="fileInput.do" method="post" name="input_form_ad" enctype="multipart/form-data">
					<table>
						<colgroup>
						<col width="130px">
						<col width="870px">
						...
						<tr>
							...
							<td><input type="text" hidden="" value="${bId }" name="bId"><select name="bType">
							<option value="basic">일반글 작성</option>
							<option value="notice">공지글 작성</option>
							<option value="event">이벤트글 작성</option></select></td>
						</tr>
						<tr>
							<th><img src="images/admin_input/t_icon.png" alt="" class="th_con">작성자</th>
							<td><input type="text" readonly="readonly" value="${bName}" name="bName"> </td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>시작일: <input type="date" name="start_date"> ~ 종료일: <input type="date" name="end_date"></td>
						</tr>
						</thead>
						<tbody>
						<!-- textarea존 -->
						...
						<tfoot>
						<tr>
							<th><img src="images/admin_input/t_icon.png" alt="" class="th_con">첨부파일1<span><img src="images/admin_input/icon_help.png" alt="이미지 혹은 문서파일만 첨부가능" class="file_ico"><input type="text" hidden="" name="f_ch"></span></th>
							<td class="filebox"><input type="file" name="bFile1" id="bFile1">이벤트등록시에만 업로드 (가로 380*세로 232)</td>
						</tr>
						<tr>
							...
							<td class="filebox"><input type="file" name="bFile2" id="bFile2">글내용에 들어갈 파일입니다.</td>
						</tr>
						<tr>
